...
const SideMenu = ({ activeMenu }) => {
  ...
  return (
    <aside className="w-64 flex-shrink-0 h-screen bg-gradient-to-b from-purple-900/40 via-indigo-900/20 to-slate-900/30 backdrop-blur-lg shadow-xl rounded-tr-3xl rounded-br-3xl p-6 flex flex-col gap-6">
